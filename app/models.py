...
class Prescription(models.Model):
    ...
    patient_sex = models.CharField(max_length=8, choices=SEX)
    ...
    drug_form = models.CharField(max_length=50, choices=DRUG_FORM)
    channel = models.CharField(max_length=50, choices=CHANNEL)
